...
async def add_data_source(
    ...
    background_tasks.add_task(process_url_source, source_id, user_id, data.url)
...
async def sync_data_source(
    ...
    # Schedule background crawling
    background_tasks.add_task(process_url_source, source_id, user_id, source["url"])
...
async def process_url_source(source_id: str, user_id: str, url: str):
